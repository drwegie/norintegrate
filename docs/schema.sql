...
-- ---------------------------------------------------------------------------
-- visa_type
-- PK is VARCHAR (e.g. 'SKILLED_WORKER')
-- ---------------------------------------------------------------------------
...
-- DAG edges: prerequisite_id → dependent_id
-- Self-dependency is prevented by CHECK constraint
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- checklist_template
-- Visa type × procedure mapping with display order
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- app_user
-- Minimal OAuth user; PK is UUID generated by gen_random_uuid()
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- user_progress
-- Per-user procedure completion tracking
-- ---------------------------------------------------------------------------
...
-- Automatically maintains updated_at on procedure and user_progress.
-- Application code must NEVER set updated_at directly.
-- =============================================================================
